...
Remaining project candidates: project certificates and usage/cost reporting are
not implemented yet. Their evaluation is recorded in
`docs/research/2026-09-24-iac-feature-requests.md`.
...
Roles, Users, Users > Roles, Groups, Groups > Roles, Data Retention, Spend
Limit, Spend Alerts, Rate Limits, Model Permissions, and Hosted Tool Permissions.
Use this group to manage project containers, service accounts, project-scoped
API keys and roles, access memberships and role assignments, and project controls.
...
| `openai_project_user` | Resource | Manage one project-user membership. | `proj_123/user_123` |
| `openai_project_users` / `openai_project_user` | Data sources | List or read project-user memberships. | `project_id`, `id` |
| `openai_project_user_role`, `openai_project_user_roles` | Resource/data sources | Manage, read, or list project-user role assignments. | `proj_123/user_123/role_123` |
| `openai_project_group` | Resource | Create a project-group membership; import is rejected because the API omits its create-only role. | N/A |
| `openai_project_groups` / `openai_project_group` | Data sources | List or read project-group memberships. | `project_id`, `group_id`, `group_type` |
| `openai_project_group_role`, `openai_project_group_roles` | Resource/data sources | Manage, read, or list project-group role assignments. | `proj_123/group_123/role_123` |
| `openai_project_data_retention` | Resource/data source | Manage or read the project data-retention singleton. | `proj_123` |
| `openai_project_spend_limit` | Resource/data source | Manage or read the project hard spend limit. | `proj_123` |
| `openai_project_spend_alert`, `openai_project_spend_alerts` | Resource/data sources | Manage, read, or list project spend alerts. | `proj_123/alert_123` |
| `openai_project_rate_limit`, `openai_project_rate_limits` | Resource/data sources | Manage, read, or list project rate limits. | `proj_123/rate_limit_123` |
| `openai_project_model_permissions` | Resource/data source | Manage or read project model permissions. | `proj_123` |
| `openai_project_hosted_tool_permissions` | Resource/data source | Manage or read project hosted-tool permissions. | `proj_123` |
...
- `examples/resources/openai_project_spend_limit/`
- `examples/resources/openai_project_model_permissions/`
- `examples/resources/openai_project_user/`
