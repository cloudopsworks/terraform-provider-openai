...
func (p *openAIProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewOrganizationCertificateResource,
	}
}
...
func (p *openAIProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewOrganizationInviteDataSource,
		NewOrganizationInvitesDataSource,
		NewOrganizationDataRetentionDataSource,
		NewOrganizationSpendLimitDataSource,
		NewOrganizationSpendAlertDataSource,
		NewOrganizationSpendAlertsDataSource,
		NewOrganizationCertificateDataSource,
		NewOrganizationCertificatesDataSource,
		NewProjectDataRetentionDataSource,
		NewProjectSpendLimitDataSource,
		NewProjectSpendAlertDataSource,
		NewProjectSpendAlertsDataSource,
		NewProjectRateLimitDataSource,
		NewProjectRateLimitsDataSource,
		NewProjectModelPermissionsDataSource,
		NewProjectHostedToolPermissionsDataSource,
		NewProjectUserRoleDataSource,
		NewProjectUserRolesDataSource,
		NewProjectGroupRoleDataSource,
